            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                    <div class="d-flex justify-content-start px-4">
                        <a href="{{route('Investormeeting.create')}}" class="btn btn-primary">Tambah Jadwal Meeting <i class="fa fa-sharp fa-light fa-arrow-right"></i></a>
                    </div>
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Pemilik Umkm
                                </th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Agenda
                                </th>
                                <th
                            ...
                            @foreach ($meeting as $data)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <form id="delete-form-{{ $data->id }}" action="{{ route('Investormeeting.destroy', $data->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
