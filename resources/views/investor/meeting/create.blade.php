...
<div class="col-12">
    ...
    <div class="card-body px-0 pt-0 pb-2">
        ...
        <table class="table align-items-center mb-0">
            <tbody>
                <form action="{{route('Investormeeting.store')}}" method="POST" enctype="multipart/form-data"> 
                    @csrf
                    <tr>
                        {{-- karyawan --}}
                        <td>
                                ...
                                <div class="row w-100">
                                    {{-- judul meeting --}}
                                        <div class="form-group">
                                            <label class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Judul Meeting:</label>
                                            <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" placeholder="Masukkan judul meeting" aria-label="Masukkan judul meeting" autofocus>
                                        </div>
                                    ...
                                    {{-- tempat meeting --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="text-dark form-control summernote @error('lokasi_meeting') is-invalid @enderror" name="lokasi_meeting" rows="7"></textarea>
