                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($data->status_verifikasi == 'Disetujui')
                                        ...
                                        <a href="{{ route('Adminmeeting.showadmin', $data->id) }}" class="btn rounded-pill btn-warning">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    ...
                                    @else
                                        <form action="{{ route('Adminmeeting.reject', $data->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <form action="{{ route('Adminmeeting.approve', $data->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('PUT')
