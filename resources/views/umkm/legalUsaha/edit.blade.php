...
<div class="col-12">
    ...
    <div class="card-body px-0 pt-0 pb-2">
        ...
        <table class="table align-items-center mb-0">
            <tbody>
                <form action="{{route('UmkmlegalUsaha.update', $legalUsaha->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <tr>
                        <td>
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small>Harap isi kembali badan usaha dengan menyesuaikan usaha.</small>
                                            @error('badan_usaha')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('NIB') is-invalid @enderror" name="NIB" aria-label="Masukkan NIB" autofocus value="{{ old('NIB', $legalUsaha->NIB)}}" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                            @error('NIB')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
