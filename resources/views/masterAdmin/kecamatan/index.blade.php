          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <div class="d-flex justify-content-start px-4">
                <a href="{{route('Master Adminkecamatan.create')}}" class="btn btn-primary">Tambah Data kecamatan <i class="fa fa-sharp fa-light fa-arrow-right"></i></a>
              </div>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="d-flex justify-content-center">
                        <form id="delete-form-{{ $data->id }}" action="{{ route('Master Adminkecamatan.destroy', $data->id) }}" method="POST" style="display:inline;">
                          @csrf
                          @method('DELETE')
                          <a href="{{route('Master Adminkecamatan.edit', $data->id)}}" class="btn btn-warning">
