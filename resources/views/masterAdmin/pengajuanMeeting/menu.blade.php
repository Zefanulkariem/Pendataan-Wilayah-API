                                ...
                                <tr>
                                    ...
                                    @if ($data->status_verifikasi == 'Disetujui')
                                        <button type="button" class="btn rounded-pill btn-success" disabled>
                                            <i class="bi bi-check-circle-fill" title="Setuju"></i> Diterima
                                        </button>
                                        <a href="{{ route('Master Adminmeeting.show', $data->id) }}" class="btn rounded-pill btn-warning">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    ...
                                    @else
                                        <form action="{{ route('Master Adminmeeting.reject', $data->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <form action="{{ route('Master Adminmeeting.approve', $data->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('PUT')
