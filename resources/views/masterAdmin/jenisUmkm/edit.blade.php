          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                <tbody>
                    <form action="{{route('Master Adminjenis-umkm.update', $jenis_umkm->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <tr>
                            <td>
                                    ...
                                    <div class="row w-100">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('jenis_umkm') is-invalid @enderror" name="jenis_umkm" value="{{ old('jenis_umkm', $jenis_umkm->jenis_umkm)}}">
                                                @error('jenis_umkm')
