            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ asset('admin/assets/img/user.png') }}" alt="profile_image"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a class="form-control btn btn-primary btn-sm ms-auto p-2" href="{{ route('logout') }}"
                                        ...
                                        <a class="form-control btn btn-primary btn-sm ms-auto p-2" href="{{ route('Master Adminprofile.edit') }}">Edit</a>  
                                </div>
                            </div>
                        </div>
                    </div>
