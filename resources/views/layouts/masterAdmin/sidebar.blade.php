<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="sidebar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('Master Adminhome') ? 'active' : '' }}" href="{{ route('Master Adminhome')}}">
            ...
            <li class="nav-item">
                ...
                <span class="nav-link-text ms-1">Jenis Umkm</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::is('Master Adminumkm.index') ? 'active' : '' }}" href="{{ route('Master Adminumkm.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        {{-- <i class="ni ni-single-02 text-info text-sm opacity-10"></i> --}}
                    </div>
                <span class="nav-link-text ms-1">Umkm</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('Master Adminprofile.index') ? 'active' : '' }}" href="{{ route('Master Adminprofile.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
